...
class DocumentGeneratorTest {
    ...
    fun documentGenerator_shouldSaveDocumentBytes() = runTest {
        ...
        Assert.assertNotNull("Document should be saved", savedBytes)
        Assert.assertArrayEquals("Document content should match", testBytes, savedBytes)
    }
    ...
    fun fileSystemManager_shouldHandleDocumentLifecycle() = runTest {
        ...
        Assert.assertNotNull("Document should exist after saving", loadedBytes)
        Assert.assertArrayEquals("Document content should match", testBytes, loadedBytes)

        // Document should appear in list
        val documentList = fileSystemManager.listDocuments()
        Assert.assertTrue("Document should appear in list", documentList.contains(documentId))
    ...
    fun fileSystemManager_shouldProvideCorrectDocumentsDirectory() {
        ...
        Assert.assertNotNull("Documents directory should not be null", documentsDir)
        Assert.assertTrue(
